...
PROMPTS = {
    ...
    "scale": "Extract scale signals such as employees, revenue, revenue growth, facilities, geographies, and stated expansion_plans (e.g., plans to double headcount or open new offices). Use only evidence present in the supplied context. Do not estimate or back-solve scale metrics from vague language like 'fast-growing' or 'leading company'.",
